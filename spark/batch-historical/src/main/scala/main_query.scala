...
// defining the area
   ...
   def main(args: Array[String]){
        ...
        // Issuing a map reduce-job to batch process the historical data and saving the results to a cassandra database.
...
// defining a function that will get and sort the distances to make the  permutations        
        def ff(aa : Int) : Array[(Double,Int)] ={
            ...
            for (ii <- 0 to slicedArrayTS.length -1){
                ...
                slicedArrayP(ii) = (slicedArrayP(ii) - start_value) 
            }
        ...
        // Issuing cleanup-mapping jobs and saving the results to cassandra
